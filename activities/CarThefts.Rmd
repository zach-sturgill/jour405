...
The distribution is skewed to the left. The majority of the data falls in the range of one standaed deviation from the mean on both sides, mostly between the mean + standard deviation end of the histogram.
